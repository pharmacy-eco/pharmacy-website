    ...
    <div className="mt-4 flex gap-14">
      <div className="">
        ...
        <div className="flex items-center gap-1">
          ...
          <DynamicIcon fill="#eab308" size={20} name="star" className="text-yellow-500" />
        </div>
      ...
      <div className="">
        {starStats.map((item, index) => {
          return <RateStar rate={item.star} ratio={item.percentage} quantity={item.count} />;
        })}
      </div>
    </div>
  );
